  ...
  projects: [
    {
      ...
      url: 'https://challenge-12-madesari.vercel.app/',
    },
    {
      id: '2',
      title: 'Portfolio 2',
      category: 'Music Player',
      image: '/images/music-thumbnails.jpg',
      description: 'Portfolio 2',
      url: 'https://challenge-11-madesari.vercel.app/',
    },
    {
      id: '3',
      title: 'Portfolio 3',
      ...
      url: 'https://challenge-9-madesari.vercel.app/',
    },
  ] as Project[],
};
  ...
  testimonials: [
    {
      id: '1',
      quote:
        "Working with Made Sari was a smooth experience from start to finish. He translated our design into clean, responsive code and even suggested improvements we hadn't thought of. Highly recommended!",
      author: {
        name: 'Sarah Tan',
    ...
    },
    {
      id: '2',
      quote:
        'Sari delivered beyond expectations. The codebase is clean, maintainable, and the UI matches our Figma designs perfectly across breakpoints.',
      author: {
        name: 'Liam Brooks',
...
export const socialLinks = [
  {
    name: 'Facebook',
    href: 'https://www.facebook.com/sari.sarinah.387750',
    icon: 'facebook',
  },
  {
    name: 'Instagram',
    href: 'https://www.instagram.com/md.sari/',
    icon: 'instagram',
  },
  {
    name: 'LinkedIn',
    href: 'https://www.linkedin.com/in/sarinah-made-sari/',
    icon: 'linkedin',
  },
...
export const footerData = {
  copyright: '© 2023 Made Sari. All rights reserved.',
  socialLinks,
};
